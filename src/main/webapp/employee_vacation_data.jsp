...
<head>
    <title>Brak wystarczającej ilości dni</title>
...
<div style="margin-left:25%">
    ...
    <div class="w3-container">
        <p>Ilość żądanych dni o urlop przekracza dopuszczlną dla Ciebie pulę.</p>
        <p>Załóż nowy wniosek<br><a class="btn" href="${vacation_form}" role="button">Złóż wniosek</a></p>
    </div>
    <%--    koniec container--%>
</div>
<%--koniec stylu--%>
